...
{
    "file": "main.py",
    "instructions": "The error message indicates that there is an undefined variable 'x' on line 10 of main.py. To fix this issue, the programmer should declare and initialize the variable 'x' before line 10."
}
...
{
    "file": "utils.py",
    "instructions": "The error message suggests that there is a syntax error on line 5 of utils.py. To resolve this issue, the programmer should carefully review the code on line 5 and ensure that all syntax rules are followed correctly."
}
$END_HYPOTHETICAL_OUTPUT$
...
export type Prompt = {
  spec: typeof spec;
  filename: "fix-error-instructions_v4.ts";
  inferred: {
    inputs: string[];
    returns: {
      file: string;
